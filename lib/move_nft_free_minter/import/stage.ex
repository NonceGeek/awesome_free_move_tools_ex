defmodule MoveNFTFreeMinter.Import.Stage do
  @moduledoc """
  ...
  alias Ecto.Multi
  alias MoveNFTFreeMinter.Explorer.Import.Runner

  @typedoc """
  Maps `t:MoveNFTFreeMinter.Import.Import.Runner.t/0` callback module to the `t:MoveNFTFreeMinter.Import.Import.Runner.changes_list/0` it
  can import.
  """
  ...
  @doc """
  Uses a single `t:MoveNFTFreeMinter.Import.Runner.t/0` and chunks the `changes_list` across multiple `t:Ecto.Multi.t/0`
  """
